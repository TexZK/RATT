...
\citef{fig:simplified_framework}.

\begin{figurehere}
	\centering
	\includegraphics[keepaspectratio=true,width=\columnwidth]{images/simplified_framework.pdf}
	\caption{Logical view of the simplified approach firmware}
	\label{fig:simplified_framework}
\end{figurehere}
...
up to 20~in/s at 1000~DPI instead of 30~in/s at 2000~DPI.
