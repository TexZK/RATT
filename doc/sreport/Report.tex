...
\newpage	%FIXME: bad caption placement
\begin{tablehere}
\centering \footnotesize
\begin{tabular}{|r|l|c|l|r|}
\hline
...
following, some computations will lead to the expected radius.

\TODO equations

\TODO latex variables
...
\hline
ttDiscDiam		& Disc diameter			& 12		& in			\\
ttNomAngSpeed	& Nominal angular speed	& 33		& rot/min		\\
ttPitchOff		& Pitch offset			& 0.00		& \%			\\
\hline
ttDiscPerim		& Disc perimeter		& 37.7		& in			\\
ttAngSpeed		& Angular speed			& 33		& rot/min		\\
ttRevRate		& Revolution rate		& 0.55		& Hz			\\
...
ssMaxDot1ms		& Maximum dots in 1~ms	& 60		& dot			\\
\hline
\end{tabular}
...
mmAngleOff		& Angle offset			& 0.00		& $^{\circ}$	\\
\hline
