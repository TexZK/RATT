...
for a good point where to start playing from (\textit{cue} point).
...
\emph{PIC18LF14K50}\CITEME by \emph{Microchip}, which is a 8-bits MCU running
at 48~MHz (16 MIPS). It is fast enough to handle a single wheel, but nothing
more advanced such as DSP, which is left to the user software application.
...
and the surface illumination LED. The sensor is an \emph{ADNS-2080}
...
\begin{figurehere}
	...
	\caption{The optical motion sensor prototype baord}
